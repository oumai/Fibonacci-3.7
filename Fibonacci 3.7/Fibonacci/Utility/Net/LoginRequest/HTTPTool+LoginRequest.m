...
//        AppDelegate *delegate =  (AppDelegate *)[[UIApplication sharedApplication] delegate];
        ...
        [userDefaults setValue:userName forKey:KEY_LOGIN_NAME];
        [userDefaults setValue:login.Data.Token forKey:KEY_LOGIN_TOKEN];
        [userDefaults removeObjectForKey:KEY_LOGIN_MANUAL];
