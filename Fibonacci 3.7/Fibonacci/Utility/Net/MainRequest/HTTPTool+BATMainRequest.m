...
+ (void)requestWithURLString:(NSString *)URLString
    ...
    NSSet *searchSet = [NSSet setWithObjects:@"/elasticsearch/recommend/gethotnews",nil];
    NSSet *batSet = [NSSet setWithObjects: @"/api/trainingteacher/GetMoreProgrammes", @"/api/trainingteacher/GetProgrammeDeltails", @"/api/EatCircle/GetHealthData", @"/api/EatCircle/UpdateHealthData", @"/api/EatCircle/HealthDataStatistics", @"/api/EatCircle/GetCalorieFromPicForHealth", @"/api/EatCircle/GetRecommendFoodList", @"/api/EatCircle/AddDietDetails", @"/api/EatCircle/GetDietDetails", @"/api/EatCircle/RemoveDietDetails", @"/api/HealthManager/GetHealthThreeSecondRecord", @"/api/EatCircle/GetAssociationFood", nil];
    NSString *baseUrl = API_URL;
    if ([searchSet containsObject:URLString])
    {
        baseUrl = BAT_SEARCH_URL;
    }
    else if ([batSet containsObject: URLString])
    {
        baseUrl = BAT_API_URL;
    }
    else if ([URLString containsString:@"/api/system/getMessageImage"])
    {
        baseUrl = BAT_API_URL;
    }
    NSString *URL = [[NSString stringWithFormat:@"%@%@",baseUrl,URLString] stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet URLQueryAllowedCharacterSet]];
...
+ (void)requestWithURLString:(NSString *)URLString
   ...
   constructingBodyWithBlock:(void (^)(id <AFMultipartFormData> formData))block
    ...
    AFHTTPSessionManager *manager = [HTTPTool managerWithBaseURL:nil sessionConfiguration:NO];
    NSString * URL = [NSString stringWithFormat:@"%@%@",API_URL,URLString];
    if (LOGIN_STATION == YES) {
        NSString * token = [[NSUserDefaults standardUserDefaults] valueForKey:@"Token"];
        if (token) {
            [manager.requestSerializer setValue:token forHTTPHeaderField:@"Token"];
