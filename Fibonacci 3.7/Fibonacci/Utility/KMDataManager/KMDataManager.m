...
- (void)uploadBloodSugarData:(BloodSugarDataModel *)model
{
    ...
    NSString *Type = [NSString stringWithFormat:@"%li", type]; //类型
    ...
    NSDecimalNumber *a = [[NSDecimalNumber alloc] initWithString:Value];
    
    NSDecimalNumber *valueNumber = [a decimalNumberByRoundingAccordingToBehavior:roundUp];
    
    NSDictionary * typeDic = @{@"1":@"早餐前", @"2":@"早餐后", @"3":@"午餐前", @"4":@"午餐后", @"5":@"晚餐前", @"6":@"晚餐后", @"7":@"睡前", @"8":@"凌晨", @"9":@"随机"};
    NSDictionary * updateTypeDic = @{@"早餐前":@"1", @"早餐后":@"4", @"午餐前":@"5", @"午餐后":@"6", @"晚餐前":@"7", @"晚餐后":@"8", @"睡前":@"9", @"凌晨":@"10", @"随机":@"3"};
    NSString *dicKey = [typeDic objectForKey:Type];
    NSString * bloodSugarType = [updateTypeDic objectForKey:dicKey];
    NSDictionary *updataDic = @{@"OBJType":@"7", @"TimeStamp":TimeStep, @"ResultValue":valueNumber, @"BloodValue":@"", @"Type":bloodSugarType};
    [self requestUpload:updataDic type:7 timer: @0];
}
