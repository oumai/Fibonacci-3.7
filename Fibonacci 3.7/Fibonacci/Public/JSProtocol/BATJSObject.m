...
- (void)gotoBloodOxygen {
    ...
    if (self.gotoBloodOxygenBlock) {
        self.gotoBloodOxygenBlock();
    }
}

- (void)gotoBloodPressure {
    
    if (self.gotoBloodPressureBlock) {
        self.gotoBloodPressureBlock();
    }
}

- (void)gotoVision {
    
    if (self.gotoVisionBlock) {
        self.gotoVisionBlock();
    }
}

- (void)gotoheartRate {
    
    if (self.gotoheartRateBlock) {
        self.gotoheartRateBlock();
    }
}

- (void)gotovitalCapacity {
    
    if (self.gotovitalCapacityBlock) {
        self.gotovitalCapacityBlock();
    }
}

- (void)gotoBloodSugar {
    
    if (self.gotoBloodSugarBlock) {
        self.gotoBloodSugarBlock();
    }
}
@end
