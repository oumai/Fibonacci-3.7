...
@property (nonatomic,copy) void(^gotoBloodOxygenBlock)(void);
@property (nonatomic,copy) void(^gotoBloodPressureBlock)(void);
@property (nonatomic,copy) void(^gotoVisionBlock)(void);
@property (nonatomic,copy) void(^gotoheartRateBlock)(void);
@property (nonatomic,copy) void(^gotovitalCapacityBlock)(void);
@property (nonatomic,copy) void(^gotoBloodSugarBlock)(void);
