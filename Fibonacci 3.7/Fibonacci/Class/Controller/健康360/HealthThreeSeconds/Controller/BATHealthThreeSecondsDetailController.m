...
- (void)setupNav{
    ...
    [backButton setImage:[UIImage imageNamed:@"nav_back_bg"] forState:UIControlStateNormal];
...
- (void)loadDataRequestWithDate:(NSString *)date{
    ...
    WeakSelf
    [HTTPTool requestWithURLString:@"/api/EatCircle/GetDietDetails"
                        parameters:dictM
                        showStatus:YES
                              type:kGET
...
- (void)deleteFoodHistryDataRequest:(NSIndexPath *)indexPath{
    ...
    WeakSelf
    [HTTPTool requestWithURLString:@"api/EatCircle/RemoveDietDetails" parameters:dictM showStatus:YES type:kGET success:^(id responseObject) {
...
- (UIView *)tableHeadView{
    if (!_tableHeadView) {
        _tableHeadView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, MainScreenWidth, 50)];
        _tableHeadView.backgroundColor = UIColorFromHEX(0xf5f5f5, 1);
        
        UIView *contentView = [[UIView alloc]initWithFrame:CGRectMake(0, 10, MainScreenWidth, 40)];
        contentView.backgroundColor = [UIColor whiteColor];
        
        UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 10, MainScreenWidth-10, 20)];
...
- (UIButton *)bottomAddButton{
    if (!_bottomAddButton) {
        ...
        _bottomAddButton.backgroundColor = AppColor;
