...
static NSString *ID = @"BATEatSearchTableViewCell.h";
...
//        headerView.frame = CGRectMake(0, 0, MainScreenWidth, 50);
//
//        UIView *view = [[UIView alloc] init];
//        view.frame = CGRectMake(0, 0, MainScreenWidth, 50);
...
- (UIView *)topSearchView{
    ...
    if (!_topSearchView) {
        _topSearchView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, MainScreenWidth, 50)];
        _topSearchView.backgroundColor = [UIColor whiteColor];
        
        UIButton *searchButton = [[UIButton alloc]initWithFrame:CGRectMake(10, 10, MainScreenWidth - 20, 30)];
