...
- (void)viewDidLoad {
    ...
    FSCalendar *calendar = [[FSCalendar alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth, 300)];
...
//    UIColor *selColor = [UIColor gradientFromColor:UIColorFromHEX(0xe7a21d, 1) toColor:UIColorFromHEX(0xeacd31, 1) withHeight:calendar.rowHeight];
    ...
    nextButton.frame = CGRectMake(MainScreenWidth-95, 0, 95, 34);
    ...
    [sureBtn setTitleColor:AppColor forState:UIControlStateNormal];
    [sureBtn setTitleColor:AppColor forState:UIControlStateHighlighted];
