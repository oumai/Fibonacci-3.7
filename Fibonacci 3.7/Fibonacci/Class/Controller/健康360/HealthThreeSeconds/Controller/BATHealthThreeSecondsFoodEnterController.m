...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(17, 0, MainScreenWidth-17, 20)];
...
- (void)requestCalorieWithImage:(UIImage *)image{
    ...
    WeakSelf
    [HTTPTool requestWithURLString:@"/api/EatCircle/GetCalorieFromPicForHealth" parameters:@{@"imageFile":base64DataStr} showStatus:YES type:kPOST success:^(id responseObject) {
...
- (UIView *)topSearchView{
    ...
    if (!_topSearchView) {
        _topSearchView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, MainScreenWidth, 56)];
        _topSearchView.backgroundColor = [UIColor whiteColor];
        
        UIButton *searchButton = [[UIButton alloc]initWithFrame:CGRectMake(15, 15, MainScreenWidth - 30, 40)];
