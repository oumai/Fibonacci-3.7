...
- (void)viewDidLoad {
    ...
    circleSlider.backgroundColor = [UIColor whiteColor];
    ...
    circleSlider.trackFillColor = AppColor;
    circleSlider.trackColor = UIColorFromRGB(122, 180, 246, 1);
//    circleSlider.startThumbTintColor = [UIColor whiteColor];
    circleSlider.diskColor = [UIColor whiteColor];
    ...
    imageView.image = [UIImage imageNamed:@"timedial"];
...
- (BATColorButton *)sureButton {
    if (!_sureButton) {
        _sureButton = [[BATColorButton alloc] initWithFrame:CGRectMake(20, 420, MainScreenWidth-20*2, 40) backBGColorArray:@[AppColor,AppColor]];
...
- (BATGraditorButton *)bedTimeButton {
    if (!_bedTimeButton) {
        ...
        [_bedTimeButton setGradientColors:@[AppColor,AppColor]];
...
- (BATGraditorButton *)wakeTimeButton {
    if (!_wakeTimeButton) {
        ...
        [_wakeTimeButton setGradientColors:@[AppColor,AppColor]];
