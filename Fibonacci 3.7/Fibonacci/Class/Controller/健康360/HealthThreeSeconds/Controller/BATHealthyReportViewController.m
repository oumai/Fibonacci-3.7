...
static NSString *const HeadID = @"BATHealthyReportHeadTableViewCell.h";
static NSString *const ContentID = @"BATHealthyReportContentTableViewCell.h";
static NSString *const BuyCarID = @"BATHealthyDrugTableViewCell.h";
static NSString *const RecommendID = @"BATHealthyRecommendTableViewCell.h";
...
//
//    if (section == 2) {
//        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 10, MainScreenWidth, 50)];
...
//
//        UIView *view1 = [[UIView alloc] initWithFrame:CGRectMake(0, 0, MainScreenWidth, 10)];
...
- (void)NewWorkOfMine {
    ...
    [HTTPTool requestWithURLString:@"/api/HealthManager/GetHealthThreeSecondRecord" parameters:dicM showStatus:YES type:kGET success:^(id responseObject) {
