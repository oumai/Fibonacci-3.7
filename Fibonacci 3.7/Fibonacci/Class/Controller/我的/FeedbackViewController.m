...
- (void)setPagesView
{
    ...
    GBLayer.frame = CGRectMake(10, 10, MainScreenWidth-20, (MainScreenHeight-kStatusAndNavHeight)*0.5);
    GBLayer.backgroundColor = [UIColor whiteColor].CGColor;
    [self.view.layer addSublayer:GBLayer];
    
    UIFont *font = [UIFont fontWithName:AppFontHelvetica size: 15];
    myTextView = [[UITextView alloc] initWithFrame:CGRectMake(10, 10, MainScreenWidth-20, CGRectGetHeight(GBLayer.frame)/2)];
    myTextView.backgroundColor = [UIColor whiteColor];
    myTextView.font = font;
    [self.view addSubview:myTextView];
    
    myLabel = [[UILabel alloc] initWithFrame:CGRectMake(MainScreenWidth-10-65, CGRectGetMaxY(myTextView.frame), 60, labelH)];
    myLabel.font = font;
    myLabel.textAlignment = NSTextAlignmentLeft;
    NSString * str = [NSString stringWithFormat:@"%li/200",myTextView.text.length];
    ...
    myButton.backgroundColor = AppColor;
    myButton.frame = CGRectMake(50, CGRectGetMaxY(GBLayer.frame)+20, MainScreenWidth - 100, buttonH);
    ...
    myButton.layer.cornerRadius = buttonH/2;
...
-(void)setUpdateImageView:(BOOL)animate
{
    ...
    layeFrame.size.height = CGRectGetMaxY(updateImageView.frame)-20;
...
-(void)setLabelAttributedText:(NSString *)text
{
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:RGB(153, 153, 153) range:NSMakeRange(redLength, text.length - redLength)];
