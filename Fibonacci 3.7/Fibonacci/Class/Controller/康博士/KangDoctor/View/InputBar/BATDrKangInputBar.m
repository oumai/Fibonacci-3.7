...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self setTopBorderWithColor:BASE_LINECOLOR width:MainScreenWidth height:0.5];
...
- (UIButton *)soundInputButton {
    ...
    if (!_soundInputButton) {
        ...
        [_soundInputButton setBackgroundImage:[KMTools imageFromColor:BASE_BACKGROUND_COLOR] forState:UIControlStateNormal];
        [_soundInputButton setBackgroundImage:[KMTools imageFromColor:BASE_LINECOLOR] forState:UIControlStateHighlighted];
