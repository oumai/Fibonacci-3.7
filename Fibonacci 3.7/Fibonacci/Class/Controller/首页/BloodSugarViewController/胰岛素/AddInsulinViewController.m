...
- (void)viewDidLoad {
    ...
    {
        [self addRightButton:@selector(saveInsulinData) titile:@"保存" titleColor:RGB(77, 77, 79)];
    }
...
- (void)pagesLayout
{
    ...
    doseField.textColor = RGB(78, 79, 81);
    doseField.backgroundColor = RGB(245, 246, 247);
    ...
    doseField.layer.borderWidth = 0.5;
    doseField.layer.borderColor = RGB(233, 234, 235).CGColor;
    ...
    nameLabel.textColor = RGB(153, 153, 153);
...
- (void)viewDidAppearLoadData
{
    ...
    birthDayPickerView = [[BATBirthDayPickerView alloc] initWithFrame:CGRectMake(0, MainScreenHeight - kStatusAndNavHeight, MainScreenWidth, 256) type:EBirthDayTypeDateAndTime];
