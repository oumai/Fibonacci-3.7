...
- (void)pagesLayout
{
    ...
    for (int i = 0; i < [segmentTitleArray count]; i++)
    {
        ...
        {
            [button setTitleColor:RGB(77, 77, 79) forState:UIControlStateNormal];
        }
    ...
    segmentLine.backgroundColor = [AppColor CGColor];
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    view.backgroundColor = RGB(233, 234, 235);
    ...
    labelTitle.textColor = RGB(143, 143, 144);
