...
- (void)addNotifity
{
    ...
    if (IS_IOS10)
    {
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            content.body = [NSString localizedUserNotificationStringForKey:@"记得吃药哦" arguments:nil];
...
- (void)addReminderForToDoItem:(ReminderModel *)model {
    ...
    NSDate * startDate = [KMTools getDateFromString:model.date dateFormat: @"yyyy-MM-dd"];
