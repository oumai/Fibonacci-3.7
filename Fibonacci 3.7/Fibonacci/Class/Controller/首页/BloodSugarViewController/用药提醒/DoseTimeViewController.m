...
- (void)initTableViewData
{
    ...
    _textField = [[UITextField alloc] initWithFrame:CGRectMake(MainScreenWidth-100, 0, 70, CELLHEIGHT)];
...
- (void)initButtonView
{
    ...
    saveButton.frame = CGRectMake(50, MainScreenHeight-100-kStatusAndNavHeight, MainScreenWidth - 100, buttonH);
    ...
    saveButton.layer.cornerRadius = buttonH/2;
    [self.view addSubview:saveButton];
    
    UIButton *deleteButton = [UIButton buttonWithType:UIButtonTypeSystem];
    deleteButton.frame = CGRectMake(50, MainScreenHeight- 50 -kStatusAndNavHeight, MainScreenWidth - 100, buttonH);
    [deleteButton.titleLabel setFont:[UIFont boldSystemFontOfSize:15.0]];
    [deleteButton setTitle: @"删除" forState:UIControlStateNormal];
    deleteButton.layer.cornerRadius = buttonH/2;
...
- (void)initTimeView
{
    birthDayPickerView = [[BATBirthDayPickerView alloc] initWithFrame:CGRectMake(0, MainScreenHeight - kStatusAndNavHeight, MainScreenWidth, 256) type:EBirthDayTypeDateTime];
