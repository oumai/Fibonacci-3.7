...
- (void)viewDidLoad {
    ...
    [self pagesLayout];
    if (!_isPreviewType) {
        [self addRightButton:@selector(saveBloodSugarNote) titile:@"保存" titleColor:RGB(77, 77, 79)];
    }
...
- (void)pagesLayout
{
    ...
    myTextView.layer.cornerRadius = 3.f;
    myTextView.layer.borderColor = RGB(232, 233, 233).CGColor;
    ...
    label.textColor = RGB(232, 233, 233);
