...
- (void)pagesLayout
{
    ...
    BloodSugarSpreadView *waterView = [[BloodSugarSpreadView alloc]initWithFrame:CGRectMake(0, waterW, waterW, waterW) status:colorType];
    waterView.backgroundColor = [UIColor clearColor];
    waterView.tag = 1001;
    UITapGestureRecognizer *tapGesture=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(goAddBloodSugar)];
    [waterView addGestureRecognizer:tapGesture];
    ...
    CGFloat waveY = 50+waterW+20+35+15;
    WXWaveView *topWaveView = [WXWaveView addToView:self.view withFrame:CGRectMake(0, waveY, MainScreenWidth,  MainScreenHeight-kStatusAndNavHeight-waveY)];
    ...
    UIView *view = [[UIView alloc]initWithFrame:CGRectMake((MainScreenWidth-waterW)/2, 60, waterW, waterW)];
    view.alpha = 1;
...
- (UILabel *)hudLabel {
    if (!_hudLabel) {
        ...
        _hudLabel.textColor = RGB(151, 151, 151);
...
- (UIButton *)recordButton
{
    if (!_recordButton) {
        ...
        [_recordButton setImage:[UIImage imageNamed:_todayHaveData?@"arrows_white":@"arrows_gray"] forState:UIControlStateNormal];
...
- (void)getTodayData
{
    ...
    if ([array count] > 0)
    {
        ...
        _model = nil;
        _model = newArray[0];
        EBloodSugarType  type = [_model.timeScale integerValue];
...
-(void)fristOpenVC2
{
    ...
    BloodSugarSpreadView *waterView = [[BloodSugarSpreadView alloc]initWithFrame:CGRectMake((MainScreenWidth-waterW)/2, kStatusAndNavHeight+50, waterW, waterW) status:colorType];
    waterView.backgroundColor = [UIColor clearColor];
    waterView.tag = 1001;
