...
- (void)initResultData
{
    ...
    [attributedString addAttribute:NSForegroundColorAttributeName value:RGB(153, 153, 153) range:NSMakeRange(3, labelText.length - 3)];
    ...
    shareButton.frame = CGRectMake(50, CGRectGetMaxY(textLabel.frame)+(iPhone5?10:50), MainScreenWidth - 100, buttonH);
    ...
    UILabel *resultHUDLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, MainScreenHeight-kStatusAndNavHeight-30, MainScreenWidth, 30)];
