...
-(void)initEyeTestViewData
{
    ...
    CGFloat scrollY = CGRectGetMaxY(eView.frame)+20;
    ...
    eyeButtonView.backgroundColor = [UIColor whiteColor];
...
-(void)initcolorBlindViewData
{
    ...
    colorBlindArray = @[@"color_3", @"color_6", @"color_7", @"color_8", @"color_9", @"color_12", @"color_15", @"color_26", @"color_29", @"color_45"];
...
-(void)initEyeListViewData
{
    ...
    for (int i = 0; i <[leftArray count]; i++)
    {
        ...
        for (int j = 0; j< viewNumber; j++)
        {
            ...
            EView *view = [[EView alloc] initWithFrame:CGRectMake(eViewX, eViewY, initialWidth, initialWidth)];
    ...
    leftLineLayer.backgroundColor = [[UIColor grayColor] CGColor];
    ...
    rightLineLayer.backgroundColor = [[UIColor grayColor] CGColor];
...
{
    JudgeView *view = [[JudgeView alloc] initWithFrame:CGRectMake(judgeX-30-5,5, 30, 30) status:status];
