...
{
    UILabel *datelabel = [[UILabel alloc] initWithFrame:CGRectMake((MainScreenWidth-200)/2, 40, 200, 50)];
    ...
    heartRoundView = [[HeartBackgroundView alloc] initWithFrame:CGRectMake((MainScreenWidth-heartViewWidth)/2, CGRectGetMaxY(datelabel.frame)+50, heartViewWidth, heartViewWidth)  ];
    [heartRoundView setLineWidth:20.f];
    [heartRoundView setLineColr:RGB(145, 203, 101)];
    heartRoundView.backgroundColor = [UIColor whiteColor];
    ...
    heartHUDLabel.textColor = [UIColor grayColor];
    ...
    valuelabel.textColor = RGB(24, 104, 241);
    ...
    kilometresLabel.textColor = RGB(24, 104, 241);
    ...
    kilometresHUDLabel.textColor = [UIColor grayColor];
    ...
    caloriesLabel.textColor = RGB(24, 104, 241);
    ...
    caloriesHUDLabel.textColor = [UIColor grayColor];
...
#pragma mark - 
-(void)resultStepAnimate
{
    CGFloat value = averageValue*10;
    heartRoundView.value += value;
    if (heartRoundView.value >=sumValue) {
        heartRoundView.value = sumValue;
        [valueTimer invalidate];
        valueTimer = nil;
    }
