...
@property (nonatomic,strong) WXWaveView        *wave;
...
- (void)pagesLayout {
    ...
    [self.headerImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(MainScreenHeight*0.45);
...
//        make.top.equalTo(self.view.mas_top).offset(64+20);
    ...
    [self.userTF mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.headerImageView.mas_bottom).offset(2*lineSpa);
        make.centerX.equalTo(self.view.mas_centerX);
    ...
    userTFLine.backgroundColor = RGB(234, 234, 234);
    ...
    passwordTFLine.backgroundColor = RGB(234, 234, 234);
    ...
    [self.registerButton mas_makeConstraints:^(MASConstraintMaker *make) {
        STRONG_SELF(self);
        make.right.equalTo(self.headerImageView.mas_right).offset(-20);
        make.top.equalTo(self.headerImageView.mas_top).offset(31);
    }];

    [self.view addSubview:self.backButton];
    [self.backButton mas_makeConstraints:^(MASConstraintMaker *make) {
        STRONG_SELF(self);
        make.left.equalTo(self.headerImageView.mas_left).offset(20);
        make.top.equalTo(self.headerImageView.mas_top).offset(20);
    ...
    [self.loginButton mas_makeConstraints:^(MASConstraintMaker *make) {
        STRONG_SELF(self);
        make.top.equalTo(self.passwordTF.mas_bottom).offset(2*lineSpa);
        make.centerX.equalTo(self.view.mas_centerX);
        make.height.mas_equalTo(height);
...
- (UIImageView *)headerImageView {
    if (!_headerImageView) {
        ...
        _headerImageView.backgroundColor = AppColor;
    }
...
- (UIImageView *)topImageView {
    if (!_topImageView) {
        _topImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"login_logo_bg"]];
...
- (UIView *)waveView {
    if (!_waveView) {
        ...
        _waveView.frame = CGRectMake(0, 0, MainScreenWidth, 6);
        _wave = [WXWaveView addToView:_waveView withFrame:_waveView.frame];
        [_wave wave];
    }
    return _waveView;
}
...
- (UITextField *)userTF {
    if (!_userTF) {
        _userTF = [UITextField textFieldWithfont:[UIFont systemFontOfSize:17] textColor:AppColor placeholder:@"请输入手机号" BorderStyle:UITextBorderStyleNone];
        UIImageView *searchIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"login_account_icon"]];
...
- (UITextField *)passwordTF {
    ...
    if (!_passwordTF) {
        ...
        _passwordTF = [UITextField textFieldWithfont:[UIFont systemFontOfSize:17] textColor:AppColor placeholder:@"请输入密码(6-18位)" BorderStyle:UITextBorderStyleNone];
        _passwordTF.secureTextEntry = YES;
        UIImageView *searchIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"login_password_icon"]];
        UIView *leftIcon = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];
        [leftIcon addSubview:searchIcon];
        [searchIcon mas_makeConstraints:^(MASConstraintMaker *make) {
            make.center.equalTo(leftIcon);
...
- (UIButton *)loginButton {
    if (!_loginButton) {
        _loginButton = [UIButton buttonWithType:UIButtonTypeCustom Title:@"登录" titleColor:[UIColor whiteColor] backgroundColor:AppColor backgroundImage:nil Font:[UIFont systemFontOfSize:17]];
...
- (UIButton *)backButton {
    if (!_backButton) {
        ...
        [_backButton setImage:[UIImage imageNamed:@"login_back_icon"] forState:UIControlStateNormal];
...
- (UIButton *)registerButton {
    if (!_registerButton) {
        _registerButton = [UIButton buttonWithType:UIButtonTypeCustom Title:@"注册" titleColor:[UIColor whiteColor]  backgroundColor:[UIColor clearColor] backgroundImage:nil Font:[UIFont systemFontOfSize:14]];
        WEAK_SELF(self);
...
- (UIButton *)forgetPasswordButton {
    if (!_forgetPasswordButton) {
        _forgetPasswordButton = [UIButton buttonWithType:UIButtonTypeCustom Title:@"忘记密码?" titleColor:AppColor  backgroundColor:[UIColor clearColor] backgroundImage:nil Font:[UIFont systemFontOfSize:14]];
        WEAK_SELF(self);
