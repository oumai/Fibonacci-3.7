...
- (void)initSexView
{
    ...
    shareButton.frame = CGRectMake(50, SexAndAge_Height- 10 - buttonH, SexAndAge_Width - 100, buttonH);
...
- (void)initAgeView
{
    UIView *ageView = [[UIView alloc] initWithFrame:CGRectMake(MainScreenWidth, MainScreenHeight*0.3, SexAndAge_Width, SexAndAge_Height)];
...
- (void)saveAgeButton:(UIButton *)button
{
    ...
    [UIView animateWithDuration:0.35f animations:^{
        ...
        rect.origin.x = MainScreenWidth;
        rect.origin.y = MainScreenHeight*0.3;
        ageView.frame = rect;
