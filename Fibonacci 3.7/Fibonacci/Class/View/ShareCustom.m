...
//        blackView.alpha = 0;
    ...
    UIView *shareView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreenHeight, kScreenWidth, Share_Scale)];
//    shareView.backgroundColor = RGB(246, 246, 246);
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, Share_Scale-labelCancelH, kScreenWidth, labelCancelH)];
    label.text = @"取消";
    label.textAlignment = NSTextAlignmentCenter;
