...
- (void)drawRect:(CGRect)rect {
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(1, 1, self.frame.size.width-2, self.frame.size.height-2) cornerRadius:self.frame.size.height/2];
